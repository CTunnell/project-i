$(document).ready(function(){
    ...
    $("main").remove();
    let keyword = $("#text-search").val().trim();   
  console.log(keyword)
    bookmaker(keyword);
   // moviemaker();
    });
    ...
    function bookmaker(keyword){
      ...
      //  var url = "https://api.nytimes.com/svc/books/v3/reviews.json?title=gone+girl&api-key=Pj4xmspyjkUbgyf0JQG8gXekbgTLhcAN"        
        $.ajax({
            url: url,
            method: "GET"
          })
